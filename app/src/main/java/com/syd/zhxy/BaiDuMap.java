            ...
            case R.id.menu_item_llsearch://根据经纬度搜索地点
                ...
                button_ll.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        final double mylg = Double.parseDouble(myEditText_lg.getText().toString().trim());
                        final double myla = Double.parseDouble(myEditText_la.getText().toString().trim());
...
//                        Toast.makeText(context, "", Toast.LENGTH_SHORT).show();
            ...
            case R.id.menu_item_sitesearch://根据地址搜索
                ...
                button_site.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        final String site_str = myEditText_site.getText().toString().trim();
